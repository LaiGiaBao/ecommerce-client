...
function SpecifiedCategory() {
  ...
  useEffect(() => {
    axios
      .get(`https://e-commerce-lgb.herokuapp.com/categories/${id}`)
      .then((response) => {
        setCategory(response.data.category);
      });
    axios
      .get(`https://e-commerce-lgb.herokuapp.com/products/byCategory/${id}`)
      .then((response) => {
  ...
  return (
    <div className="product-list pt-5 mt-5">
      ...
      >
        <option value="1" class="h5">
          From lowest to highest
        </option>
        <option value="2" class="h5">
          {" "}
      ...
      <div
        className="items"
        style={{ whiteSpace: "normal", marginLeft: "7.5rem" }}
      >

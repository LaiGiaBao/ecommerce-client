...
function Product() {
  ...
  useEffect(() => {
    axios
      .get(`https://e-commerce-lgb.herokuapp.com/products/byId/${id}`)
      .then((response) => {
        setProduct(response.data);
        setColors(response.data.colors.split(","));
      });
    axios
      .get(`https://e-commerce-lgb.herokuapp.com/comments/${id}`)
      .then((response) => {
  ...
  const deleteComment = (id) => {
    axios
      .delete(`https://e-commerce-lgb.herokuapp.com/comments/${id}`, {
  ...
  const editComment = (id) => {
    ...
    axios
      .put(
        `https://e-commerce-lgb.herokuapp.com/comments/${id}`,
        { comment: newComment },
        { headers: { accessToken: localStorage.getItem("accessToken") } }
      )
      .then(() => {
  ...
  const addComment = () => {
    axios
      .post(
        "https://e-commerce-lgb.herokuapp.com/comments",
        {
      ...
      <div class="row d-flex justify-content-center align-items-center h-100 py-1 my-1">
        <div class="bg-white col-md-10 pt-4 row">
          ...
          <div class="col-md-8 pt-5">
            <div className="box">
              <div className="row">
                <h2 class="display-3 text-uppercase product-name">
                  {product.name}
                </h2>
              ...
              <div class="px-1">
                ...
                <button class="btn btn-primary btn-lg btn-block p-3 px-5 font-weight-bold cart ">
                  {" "}
                  ADD TO CART{" "}
                </button>
        ...
        <div class="col-md-10 float-left">
          <div class="col-md-8 pt-5 mt-5">
            ...
            <div className="add-comment-container row py-2">
              ...
              <button
                class="col-md-1 btn btn-primary btn-lg comment-bt"
                onClick={addComment}
              >
            ...
            <div className="col-md-11 pt-4 rounded">
              {comments.map((comment, key) => (
                <div
                  class="row pt-3 bg-light mb-3 mx-0 rounded"
                  style={{ width: "99.7%" }}
                >
                  ...
                  <div className="comment col-md-9 h5 row" key={key}>
                    ...
                    <div class="h5 text-break">{comment.commentBody}</div>
